...
NEUG_REGISTER_TEMPLATE_MODULE(MutableCsr, IpAddress);
...
NEUG_REGISTER_TEMPLATE_MODULE(SingleMutableCsr, IpAddress);
...
NEUG_REGISTER_TEMPLATE_MODULE(EmptyCsr, IpAddress);
